...
export default function Swap({ history }: RouteComponentProps) {
  ...
  return (
    <Page>
      <AppBody>
        <AppHeader title={t('Exchange')} subtitle={t('Trade SART in an instant')} />
                ...
                {allowedSlippage !== INITIAL_ALLOWED_SLIPPAGE && (
                  <RowBetween align="center">
                    ...
                    <Text bold color="primary">
                      {
                        (allowedSlippage === 1200) ? 0.2 :
                        (allowedSlippage === 1500) ? 0.3 :
                        (allowedSlippage === 2000) ? 0.4 :
                        (allowedSlippage === 2500) ? 1
                      : allowedSlippage / 100}%
                    </Text>
                  </RowBetween>
                )}
